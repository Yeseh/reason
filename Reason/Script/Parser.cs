...
public class Parser
{
    ...
    private static readonly TokenType[] RefTokens = { TokenType.At, TokenType.Dollar, TokenType.Pound };
    private static readonly TokenType[] AssignmentTokens = { TokenType.Env, TokenType.Secret, TokenType.Var };
